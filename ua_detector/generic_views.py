...
__all__ = (
     ...
     'AjaxCreateView','MobileCreateView'
...
#see:https://docs.djangoproject.com/en/1.5/topics/class-based-views/generic-editing/        
...
class AjaxCreateView(AjaxableResponseMixin,MobileCreateView):
    def dispatch(self, *args, **kwargs):
